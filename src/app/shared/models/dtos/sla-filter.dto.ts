...
export interface SlaFilterLike {
  towers?: number[];
  islands?: number[];
  subislands?: number[];
  subjects?: number[];
...
export interface SlaFilterOptionsDTOLike
  extends SortOptionsLike,
    SlaFilterLike {}

export class SlaFilterOptionsDTO
  extends SortOptions<
    SlaFilterOptionsDTO,
    SlaFilterOptionsDTOLike
  >
  implements SlaFilterOptionsDTOLike
{
  towers?: number[];
  islands?: number[];
  subislands?: number[];
  ...
  override reset(options?: Partial<SlaFilterOptionsDTOLike>): void {
    super.reset(options);
